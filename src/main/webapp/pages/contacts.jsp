                ...
                <div class="col-12 col-lg-7">
                    <div class="border border-3 border-dark" style="background-color: whitesmoke;">
                        <div class="text-wrapper">
                            <div class="content">
                                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>Наши контакты</strong></h3>
...
<footer class="bg-dark text-center text-white fixed-bottom">
    <div class="container p-4 pb-0">
        ...
        <section class="mb-4">
            ...
            <!-- Github -->
            <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/hikkiray" role="button">
